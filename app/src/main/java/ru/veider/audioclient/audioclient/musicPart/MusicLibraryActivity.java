...
//        fabStorage = findViewById(R.id.fab);
        ...
        adapter = new MediaModelAdapter((mediaModel, position) ->{
            Intent intent = new Intent(this, MusicPlayerService.class);
            intent.putExtra("position", position);
            startService(intent);
            MusicMediaPlayerActivity.start(MusicLibraryActivity.this, position);

        });

        recyclerView.setAdapter(adapter);

        MusicLibraryActivityPermissionsDispatcher.loadFromExternalWithPermissionCheck(MusicLibraryActivity.this);
    ...
    void loadFromExternal() { // reading a file
        ArrayList<File> myBooks = findAudioBooks(Environment.getExternalStoragePublicDirectory("Music"));
